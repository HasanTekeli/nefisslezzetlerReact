        ...
        <div>
            ...
            <p>Bizimle iletişime geçebileceğiniz kanallar:</p>
                ...
                <Row xs={"1"} lg={"2"}>
                    ...
                    <p className="fa fa-phone"><a href={"tel:+90 382 213 85 44"}>  +90 382 213 85 44</a></p><br/>

                    <p className="fa fa-phone"><a href={"tel:+90 546 480 00 68"}>  +90 546 480 00 68</a></p><br/>
